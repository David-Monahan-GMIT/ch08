...
public class AddressBook extends JFrame {
	...
	private class SaveAction extends AbstractAction {
		...
		public SaveAction() {
			putValue(NAME, "Save");
			putValue(SMALL_ICON, new ImageIcon(getClass().getResource("images/Save24.png")));
	...
	private class DeleteAction extends AbstractAction {
		...
		public DeleteAction() {
			...
			putValue(SMALL_ICON, new ImageIcon(getClass().getResource("images/Delete24.png")));
	...
	private class SearchAction extends AbstractAction {
		...
		public SearchAction() {
			...
			putValue(SMALL_ICON, new ImageIcon(getClass().getResource("images/Find24.png")));
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (lastName != null) {
				...
				java.util.List<AddressBookEntry> people = database.findPerson(lastName);
				...
				if (!people.isEmpty()) {
					...
					JOptionPane.showMessageDialog(desktop,
							"Entry with last name \"" + lastName + "\" not found in address book");
