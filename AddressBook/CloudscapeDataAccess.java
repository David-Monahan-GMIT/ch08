   ...
   public CloudscapeDataAccess() throws Exception
   {
      ...
      sqlFind = connection.prepareStatement(
         "SELECT names.personID, firstName, lastName, " +
            ...
            "eircode, phoneID, phoneNumber, emailID, " +
            "emailAddress " +
...
/*      sqlPersonID = connection.prepareStatement(
      ...
      sqlPersonID = connection.prepareStatement(
    	         "SELECT MAX(personID) FROM names" );
...
//            return null;	         
	         ...
	         //TODO needs a loop, Should return an ArrayList containing all the found people
	         // create new AddressBookEntry
	         people.add(new AddressBookEntry( 
	            resultSet.getInt( 1 ) ));
